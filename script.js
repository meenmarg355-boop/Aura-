...
// Global System Variables - Changed sessionStorage to localStorage for Multi-Device/Persistent Login
let users = JSON.parse(localStorage.getItem('hubUsers')) || [];
let currentUser = localStorage.getItem('activeHubUser') || null; 
let files = [];
let historyLog = [];
...
function checkAuthState() {
    // Refresh the latest state from localStorage
    currentUser = localStorage.getItem('activeHubUser') || null;
    users = JSON.parse(localStorage.getItem('hubUsers')) || [];
...
function handleLogin() {
    ...
    if (account) {
        ...
        // Changed to localStorage to make session persistent across windows/devices
        localStorage.setItem('activeHubUser', account.username); 
        checkAuthState();
...
function handleLogout() {
    currentUser = null; 
    localStorage.removeItem('activeHubUser'); // Clear from localStorage
